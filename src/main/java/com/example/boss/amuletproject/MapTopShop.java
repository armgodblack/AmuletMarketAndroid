...
public class MapTopShop extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.maptopshop);
        connect();
    ...
    private void connect() {
        ...
        new AsyncTask<Void, Void, Void>(){
            ...
            protected Void doInBackground(Void... voids) {
                try {
                    Intent intent = MapTopShop.this.getIntent();
                    if (intent.getExtras() != null) {
                        String id_shop = intent.getStringExtra("ID_Shop");
                        Log.d("ID", "IdMarket1 : " + id_shop);

                        URL url = new URL(ipaddress.getIp() + "amuletmarket/JSON_ShowMapShop?ID_Shop="+id_shop);
