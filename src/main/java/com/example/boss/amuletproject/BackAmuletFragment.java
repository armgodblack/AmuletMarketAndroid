 ...
 */
public class BackAmuletFragment extends Fragment {

    ipaddress ipaddress = new ipaddress();
    SmartImageView imageAmuletBack;
    private ProgressDialog progressDialog;
    ArrayList<String> exData1,exData2,exData3;

    public BackAmuletFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_back_amulet, container, false);
        exData2 = new ArrayList<String>();
        imageAmuletBack =(SmartImageView)rootView.findViewById(R.id.imageAmuletBack);
